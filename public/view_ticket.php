       ...
       <?php if ($role === 'Admin'): ?>
            <div class="border-t border-gray-800 pt-4 mt-4">
                <form action="view_ticket.php?id=<?= $ticketId ?>" method="POST" class="space-y-2">
                    <label for="engineer_id" class="block text-xs text-gray-400">Assign or Change Engineet:</label>
                    <div class="flex gap-2">
                        ...
                        <button type="sumbit" name="assign_engineer" class="bg-orange-600 hover:bg-orabge-500 text-white text-xs px-4 py-1.5 rounded transition">
                            Assign
                        </button>
                    </div>
                </form>
